...
def process_weather_data(r):
    ...
    try:
        ...
        logging.info(count_dim_clouds, "Запись успешно вставлена в таблицу 'dim_clouds'")
        ...
        logging.info(count_dim_wind, "Запись успешно вставлена в таблицу 'dim_wind'")
        count_stage_fact_weather = insert_stage_fact_weather(cursor)
        logging.info(count_stage_fact_weather, "Запись успешно вставлена в таблицу 'stage_fact_weather'")
        connection.commit()
        cursor.close()
        connection.close()
